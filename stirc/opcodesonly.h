...
enum stirbce_opcode {
  ...
  STIRBCE_OPCODE_CALL_LOGICAL_NOT = 9, // two opcodes = BOOLEANIFY
  ...
  //STIRBCE_OPCODE_UNUSED = 48, // TODO invent some use for this
  STIRBCE_OPCODE_FUN_HEADER = 49, // followed by double
  STIRBCE_OPCODE_PUSH_NIL = 50,
  STIRBCE_OPCODE_STR_CMP = 51,
  ...
  STIRBCE_OPCODE_SUFSUB = 105,
  STIRBCE_OPCODE_FUN_TRAILER = 106,
  ...
  STIRBCE_OPCODE_PATH_ABSOLUTIFY = 116, // true/false, path
  STIRBCE_OPCODE_DICTSET_MAINTAIN = 117,
