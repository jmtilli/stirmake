...
enum stirbce_opcode {
  ...
  STIRBCE_OPCODE_FILE_GETALL = 97,
  STIRBCE_OPCODE_FILE_SEEK_TELL = 98,
  STIRBCE_OPCODE_FILE_FLUSH = 99,
  // add rule or deps
  STIRBCE_OPCODE_RULE_ADD = 100,
  STIRBCE_OPCODE_DEPS_ADD = 101,
  STIRBCE_OPCODE_DICTHAS = 102,
  STIRBCE_OPCODE_SCOPE_HAS = 103,
  STIRBCE_OPCODE_SUFSUBONE = 104,
  STIRBCE_OPCODE_SUFSUBALL = 105,
  STIRBCE_OPCODE_SUFFILTER = 106,
  STIRBCE_OPCODE_GETPROJTOP = 107,
};
