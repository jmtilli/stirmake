...
enum {
  ADD_DEP_ENTRY_BLOCK_SIZE = 340,
  RULEID_BY_DEP_ENTRY_LATER_BLOCK_SIZE = 510,
  RULEID_BY_DEP_ENTRY_BLOCK_SIZE = 16,
  RULEID_BY_TGT_SIZE = 8192,
  RULEIDS_BY_DEP_SIZE = 8192,
  STATHASH_SIZE_RB = 8192,
  ACCESSHASH_SIZE_RB = 8192,
  STATHASH_SIZE = 256*1024,
  ACCESSHASH_SIZE = 256*1024,
  STATHASH_SIZE_INIT = 256,
  ACCESSHASH_SIZE_INIT = 256,
  TGTS_SIZE = 4,
  DEPS_SIZE = 8,
  DEPS_REMAIN_SIZE = 8,
  ONE_RULEID_BY_DEP_SIZE = 32,
  ADD_DEP_SIZE = 8,
  ADD_DEPS_SIZE = 8192,
